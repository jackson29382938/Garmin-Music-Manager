...
final class MTPCommandService {
    ...
    func sync(
        ...
        try await performExclusive {
            ...
            try self.fileManager.createDirectory(at: targetFolder, withIntermediateDirectories: true, attributes: [.posixPermissions: 0o700])
            ...
            for track in tracks {
                ...
                try self.fileManager.createDirectory(at: targetURL.deletingLastPathComponent(), withIntermediateDirectories: true, attributes: [.posixPermissions: 0o700])
